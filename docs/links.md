...
One file, everything reachable from it. Add a line rather than pasting a URL in chat.
...
| Mirror node REST, testnet | https://testnet.mirrornode.hedera.com/api/v1 |
| Portal and testnet faucet | https://portal.hedera.com/ |
| Hedera docs | https://docs.hedera.com |
| Hedera AI Agent Kit | https://docs.hedera.com/solutions/ai/agent-kit |
| Agent Kit on npm | https://www.npmjs.com/package/hedera-agent-kit |
| Hedera MCP and agent skills | https://hedera.com/blog/hedera-mcp-agent-skills/ |
| Hedera hosted MCP, testnet | https://agentic-testnet-mcp.hedera.com/mcp |
| Blocky402 facilitator, testnet | https://api.testnet.blocky402.com |
| Blocky402 docs | https://blocky402.com/docs/quickstart/ |
