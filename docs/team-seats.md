...
| Live judging round 2, Tue Sep 15 | Nasaa | Claimed 2026-09-05. Round 1 is asynchronous, round 2 is not. Presenting means answering questions, so fluency in the known limits matters more than the pitch. Rehearse in the slack after the Sep 11 freeze |
